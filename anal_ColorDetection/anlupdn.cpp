...
*/
	sprintf(filename0, "MO_LMColor_5Oct2023.rst", argv[1]);
	sprintf(filename1, "MO_LMColor_5Oct2023.udn", argv[1]);
	sprintf(filename2, "MO_LMColor_5Oct2023.ccs", argv[1]);
	//TN_LMColor_14Sep2019
